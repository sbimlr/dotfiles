...
augroup languages
	...
	autocmd BufNewFile,BufRead {*.ada,*.ada_m,*.adb,*.adc,*.ads,*.gpr} set ft=ada
	...
	autocmd BufNewFile,BufRead {.curlrc,.gitignore,gitignore,.gitattributes,gitattributes,.hgignore,.jshintignore} set ft=conf
